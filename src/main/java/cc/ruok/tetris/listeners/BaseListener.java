...
public class BaseListener implements Listener {
    ...
    public void onForm(PlayerFormRespondedEvent event) {
        if (event.getFormID() == 1145142233) {
            ...
            switch (String.valueOf(map.get(0))) {
                case "0.5x": config.speed = 0; break;
                case "1.0x": config.speed = 1; break;
                case "1.5x": config.speed = 2; break;
                case "2.0x": config.speed = 3; break;
            }
